...
func main() {
	...
	getR.HandleFunc("/products", ph.ListAll).Queries("currency", "{[A-Z]{3}}") // 3 letter currency codes
	...
	s := http.Server{
		...
		ErrorLog:     l.StandardLogger(&hclog.StandardLoggerOptions{}), // set the logger for the server, hclog standard
